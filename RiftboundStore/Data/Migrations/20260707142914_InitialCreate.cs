        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Edition = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupEvent = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardNumber = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    CardEdition = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    CardLanguage = table.Column<int>(type: "INTEGER", nullable: false),
                    CardIsFoil = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_Number_Edition_Language_IsFoil",
                table: "Cards",
                columns: new[] { "Number", "Edition", "Language", "IsFoil" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_UserId_CardId",
                table: "CartItems",
